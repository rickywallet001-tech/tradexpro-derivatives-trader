...
const AccountsInfoLoader = ({ is_desktop, is_logged_in, speed }) => (
    <ContentLoader
    ...
    >
        {is_logged_in ? <LoggedInPreloader is_desktop={is_desktop} /> : <LoggedOutPreloader is_desktop={is_desktop} />}
    </ContentLoader>
);
...
const LoggedInPreloader = ({ is_desktop }) => (
    <>
        {is_desktop ? (
            <React.Fragment>
